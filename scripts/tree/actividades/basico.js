...
Technotip.Basico.prototype= {
    ...
    preload:function(){    
        ...
        game.load.image('interfaz','img/paraArmar/Nivel_basico/interfaz.png')        
        game.load.image('pienza1','img/paraArmar/Nivel_basico/pieza1.png')
        game.load.image('pienza2','img/paraArmar/Nivel_basico/pieza2.png')
        game.load.image('pienza3','img/paraArmar/Nivel_basico/pieza3.png')
        game.load.image('pienza4','img/paraArmar/Nivel_basico/pieza4.png')
        game.load.image('pienza5','img/paraArmar/Nivel_basico/pieza5.png')
        game.load.image('pienza6','img/paraArmar/Nivel_basico/pieza6.png')
        game.load.image('pienza7','img/paraArmar/Nivel_basico/pieza7.png')
        game.load.image('pienza8','img/paraArmar/Nivel_basico/pieza8.png')
    ...
    create:function(){
        ...
        /*Comienzan las zonas*/
        zona1 = game.add.image(388,35,'pienza1');
        zona1.anchor.setTo(0.5,0.5)
        zona1.scale.setTo(1.2,1.2)
        zona1.alpha=0

        zona2 = game.add.image(415,12,'pienza2');
        zona2.anchor.setTo(0.5,0.5)
        zona2.scale.setTo(1.2,1.2)
        zona2.alpha=0

        zona3 = game.add.image(162,573,'pienza3');
        zona3.anchor.setTo(0.5,0.5)
        zona3.scale.setTo(1.2,1.2)
        zona3.alpha=0

        zona4 = game.add.image(273,105,'pienza4');
        zona4.anchor.setTo(0.5,0.5)
        zona4.scale.setTo(1.2,1.2)
        zona4.alpha=0

        zona5 = game.add.image(568,571,'pienza5');
        zona5.anchor.setTo(0.5,0.5)
        zona5.scale.setTo(1.2,1.2)
        zona5.alpha=0

        zona6 = game.add.image(726,9,'pienza6');
        zona6.anchor.setTo(0.5,0.5)
        zona6.scale.setTo(1.2,1.2)
        zona6.alpha=0

        zona7 = game.add.image(44,19,'pienza7');
        zona7.anchor.setTo(0.5,0.5)
        zona7.scale.setTo(1.2,1.2)
        zona7.alpha=0

        zona8 = game.add.image(88,177,'pienza8');
        zona8.anchor.setTo(0.5,0.5)
        zona8.scale.setTo(1.2,1.2)
        zona8.alpha=0

        a1 = this.makeDragObj(pieza1,zona1,true,50, false,false);   
        a2 = this.makeDragObj(pieza2,zona2,true,50, false,false);       
        a3 = this.makeDragObj(pieza3,zona3,true,50, false,false);       
        a4 = this.makeDragObj(pieza4,zona4,true,50, false,false);       
        a5 = this.makeDragObj(pieza5,zona5,true,50, false,false);       
        a6 = this.makeDragObj(pieza6,zona6,true,50, false,false);       
        a7 = this.makeDragObj(pieza7,zona7,true,50, false,false);       
        a8 = this.makeDragObj(pieza8,zona8,true,50, false,false);       
