Technotip.Intermedio = function(game){
    var sprite;
    var group;
    var group2;
    var cursors;
...
Technotip.Intermedio.prototype= {
    ...
    preload:function(){    
        ...
        game.load.image('interfaz','img/paraArmar/Nivel_medio/interfaz.png')        
        game.load.image('pienza1','img/paraArmar/Nivel_medio/pieza1.png')
        game.load.image('pienza2','img/paraArmar/Nivel_medio/pieza2.png')
        game.load.image('pienza3','img/paraArmar/Nivel_medio/pieza3.png')
        game.load.image('pienza4','img/paraArmar/Nivel_medio/pieza4.png')
        game.load.image('pienza5','img/paraArmar/Nivel_medio/pieza5.png')
        game.load.image('pienza6','img/paraArmar/Nivel_medio/pieza6.png')
    ...
    create:function(){
       ...
       this.noagarradoFx = this.add.audio('noagarrado',1,false);
        ...
        a1 = this.makeDragObj(pieza1,zona1,true,20, false,false);   
        a2 = this.makeDragObj(pieza2,zona2,true,20, false,false);       
        a3 = this.makeDragObj(pieza3,zona3,true,20, false,false);       
        a4 = this.makeDragObj(pieza4,zona4,true,20, false,false);       
        a5 = this.makeDragObj(pieza5,zona5,true,20, false,false);       
        a6 = this.makeDragObj(pieza6,zona6,true,20, false,false);       
           

        this.puntosXimagen=6;        
           ...
           if(zonaDestino.constructor === Array){
               ...
               if(resultadoTestHit[0]==true){
                ...
                if(objDraggable.proximidadCentros()<numProximidad ){
                  ...
                  caminarX = caminarX+108;
                  caminarY = caminarY-125
